...
#' p.f = newar(~flu, levels=universe, values=c(.1, .9))
#' p.t_f = newar(~temp|flu, levels=universe, values=c(.9, .1, .01, .99))
#' p.h_t = newar(~headache|temp, levels=universe, values=c(.8, .1, .1, .9))
#'
