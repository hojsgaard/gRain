...
\includegraphics[width=\maxwidth]{figures/grain-chest-LS-1} \caption[Chest clinic example from LS]{Chest clinic example from LS.}\label{fig:chest-LS}
\end{figure}
...
\end{alltt}
\begin{verbatim}
##   dysp bronc either lung tub xray asia smoke   Freq
...
size. Yey, \grbn\ has been used succesfully in models with tens of
...
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figures/grain-unnamed-chunk-30-1} 
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in getgin(x, "{}isCompiled"{}): object 'gr.dG' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in getgin(x, "{}isCompiled"{}): object 'gr.dG' not found}}\end{kframe}
\end{knitrout}
